...
- 5.인사 평가
    ...
    ![인사평가-이미평가한 직원.gif](./images/인사평가-이미평가한직원.gif)
...
- 2.결재 문서 임시 저장
    ...
    ![결재문서 임시저장1.gif](./images/결재문서임시저장1.gif)
    
    결재 문서 작성 중 다른 페이지로 이동하려고 하는 경우 나타나는           임시 저장 확인 창 → 임시 저장함으로 이동
    
    ![결재문서 임시저장2.gif](./images/결재문서임시저장2.gif)
    
    임시 저장함으로 이동 된 결재 문서
    
- 3.결재 문서 회수
    
    ![결재문서 회수.gif](./images/결재문서회수.gif)
...
- 4.결재 문서 승인/반려
    ...
    ![알림페이지에서 결재함 이동.gif](./images/알림페이지에서결재함이동.gif)
    
    결재 문서를 확인하기 위해서 상단에 뜬 알림 페이지를 통해서도 이동 
    
    ![결재문서 승인처리1.gif](./images/결재문서승인처리1.gif)
    
    결재 문서를 승인또는 반려 하는 경우 사유 입력
    
    ![결재문서 승인처리2.gif](./images/결재문서승인처리2.gif)
...
- 6.결재 템플릿 추가(by 관리자)
    ...
    ![결재문서 양식생성1.gif](./images/결재문서양식생성1.gif)
    
    관리자만 이동할 수 있는 카테고리/양식 관리 페이지에서 양식 추가
    
    ![결재문서 양식생성2.gif](./images/결재문서양식생성2.gif)
    
    ![결재문서 양식생성3.gif](./images/결재문서양식생성3.gif)
    
    사용자의 마음대로 양식 추가
    
    ![결재문서 양식생성4.gif](./images/결재문서양식생성4.gif)
    
    사용자가 임의로 형식 지정도 가능
    
    ![결재문서 양식생성5.gif](./images/결재문서양식생성5.gif)
    
    템플릿 생성 완료
    
    ![결재문서 양식생성6-새로운 탬플릿 적용.gif](./images/결재문서양식생성6-새로운탬플릿적용.gif)
    
    ![결재문서 양식생성7-새로운탬플릿적용.gif](./images/결재문서양식생성7-새로운탬플릿적용.gif)
    
    새로운 탬플릿으로 바로 결재 문서 작성
    
    ![결재문서 양식 수정1.gif](./images/결재문서양식수정1.gif)
    
    ![결재문서 양식 수정2.gif](./images/결재문서양식수정2.gif)
    
    생성한 양식 수정
    
    ![결재문서 양식 수정3.gif](./images/결재문서양식수정3.gif)
