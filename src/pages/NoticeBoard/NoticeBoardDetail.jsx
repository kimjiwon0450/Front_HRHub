          ...
          {attachments.map((url, idx) => (
            <div key={idx} style={{ marginBottom: '10px' }}>
              {isImageFile(url) ? (
                ...
                <a href='#!' onClick={() => handleDownloadClick(url)}>
            ...
            <div key={comment.noticeCommentId} className='comment-item'>
              ...
              {editCommentId === comment.noticeCommentId ? (
                <>
                  ...
                  />
                  <button
                    onClick={() => handleEditComment(comment.noticeCommentId)}
                  >
                    저장
                  </button>
                ...
                <>
                  ...
                  comment.writerName === userName ? (
                    <div className='comment-buttons'>
                      ...
                      <button
                        onClick={() =>
                          handleDeleteComment(comment.noticeCommentId)
                        }
                      >
                        삭제
                      </button>
